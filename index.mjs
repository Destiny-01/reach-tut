...
const theNFT= await stdlib.launchToken(accAlice, "Mona", "NFT",{supply:1})
const nftParams ={
  nftId: theNFT.id,
  numTickets: 10
}
const OUTCOME =["Your number didn't match", "Your number matches!"
]
...
await Promise.all([
  backend.Alice(ctcAlice, {
    ...
    seeHash: (value)=>{
      console.log(`Winnig number hash: ${value}`);
    }
